...
{
    public class AsyncMailSender : IMailSender
    {
        #region Properties
        ...
        public string SendEmail()
        {
            try
            {
                ...
                client.SendAsync(mail, this.TokenIdentifier);
        ...
        public string SendEmail(SendCompletedEventHandler callbackEvent)
        {
            try
            {
                MailMessage mail = CreateMessage();
                ...
                client.SendCompleted += new  SendCompletedEventHandler(callbackEvent);
                client.SendAsync(mail, this.TokenIdentifier);
